...
const CategoryDetail = () => {
  ...
  const { transactionsPerCategory, totalAnnualExpense, isLoading, error } =
      ...
      <div className=' bg-gray-100'>
        <div className='mx-8 p-4'>
          <div className='flexmb-2 '>
            <h2 className='text-sm text-600 mb-1 font-semibold'>
              Educación y cultura
            </h2>
          </div>

          <h1 className='text-3xl font-bold mb-4'>
            {formatBalance(totalAnnualExpense.toFixed(2))} €
          </h1>
          <h3 className='text-sm font-medium mb-1 font-semibold'>
            Gasto Anual
          </h3>
        </div>
        ...
        <main className='p-4'>
          <div className='h-64 w-full p-4'>
            ...
            <p className='text-xs text-gray-500 mt-1'>
              Representa un 24% de tu gasto total
            </p>
          </div>
        </main>
      </div>
